        ...
        <nav className="border-w">
          <div className="container mx-auto px-4 flex h-12 items-center justify-between">
            ...
            <div
              ...
              } sm:flex flex-col sm:flex-row sm:w-full sm:justify-center sm:gap-12 absolute sm:relative left-0 right-0 top-12 sm:top-0 bg-white sm:bg-transparent z-50 border-b sm:border-0 shadow-md sm:shadow-none`}
            >
              <NavLink
                to="/"
                className={({ isActive }) =>
